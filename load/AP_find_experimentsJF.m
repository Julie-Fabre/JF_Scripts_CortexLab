...
for curr_day = 1:length(days)  
    ...
    if ~isempty(protocol)
        ...
        for curr_exp = 1:length(exp_nums)
            ...
            [block_filename, block_exists] = AP_cortexlab_filenameJF(animal,day,exp_nums(curr_exp),'block');
            [protocol_filename,protocol_exists] = AP_cortexlab_filenameJF(animal,day,exp_nums(curr_exp),'protocol');
