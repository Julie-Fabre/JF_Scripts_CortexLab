function protocols = AP_list_experimentsJF(animal,day)
...
experiments_dir = dir(AP_cortexlab_filenameJF(animal,day,1,'expInfo'));
...
for curr_exp = 1:length(experiment_num)
    ...
    [block_filename, block_exists] = AP_cortexlab_filenameJF(animal,day,experiment_num(curr_exp),'block');
    [protocol_filename,protocol_exists] = AP_cortexlab_filenameJF(animal,day,experiment_num(curr_exp),'protocol');
