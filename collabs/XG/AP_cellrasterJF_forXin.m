function AP_cellrasterJF_forXin(align_times,align_groups,unit_sort)
% based on Andy's AP_cellraster(align_times,align_groups,unit_sort)
%
...
raster_window = [-0.02,0.02];
psth_bin_size = 0.0001;
