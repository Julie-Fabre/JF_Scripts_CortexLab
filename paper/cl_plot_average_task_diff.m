...
function cl_plot_average_task_diff(task_data, idx, contra, center, keepUnits, keepVis)
...
try
    ...
    %go 1
    test_image_go1_init = squeeze(go1_contra(these_units, 2, :));
    %test_image_go1_init = (test_image_go1_init - nanmean(test_image_go1_init(:, val_t_1), 2)) ./ ...
    %    nanstd(test_image_go1_init(:, val_t_1), [], 2);
    
    test_image_go2_init = squeeze([go2_contra(these_units, 2, :)]);    
    %test_image_go2_init = (test_image_go2_init - nanmean(test_image_go2_init(:, val_t_1), 2)) ./ ...
     %   nanstd(test_image_go2_init(:, val_t_1), [], 2);
    
     test_image_noGo_init = squeeze(noGo_contra(these_units, 2, :));
   % test_image_noGo_init = (test_image_noGo_init - nanmean(test_image_noGo_init(:, val_t_1), 2)) ./ ...
   %     nanstd(test_image_noGo_init(:, val_t_1), [], 2);

    test_image_go1 = test_image_go1_init - test_image_go2_init;
    test_image_go1 = (test_image_go1 - nanmean(test_image_go1(:, val_t_1), 2)) ./ ...
        nanstd(test_image_go1(:, val_t_1), [], 2);
    test_image_go2 = test_image_go1_init - test_image_noGo_init;
    test_image_go2 = (test_image_go2 - nanmean(test_image_go2(:, val_t_1), 2)) ./ ...
        nanstd(test_image_go2(:, val_t_1), [], 2);
    test_image_noGo = test_image_go2_init - test_image_noGo_init;
