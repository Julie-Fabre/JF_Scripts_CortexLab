...
%% Load imaging data
corona = 0;
[data_path,data_path_exists] = AP_cortexlab_filenameJF( animal,day,experiment,'imaging',site);
...
if imaging_exists && load_parts.imaging
    ...
    elseif cam_color_n == 2
        ...
        min_frames = min([size(Vn,2),size(Vh,2), size(tn,2)]);
...
[ephys_path,ephys_exists] = AP_cortexlab_filenameJF(animal,day,experiment,'ephys',site);
...
if ephys_exists && load_parts.ephys
    ...
    [data_path,data_path_exists] = AP_cortexlab_filenameJF(animal,day,experiment,'ephysraw',site);
