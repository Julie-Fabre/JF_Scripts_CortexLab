...
% DMS vs PS 
%% 
[task_data, session_data] = cl_loadPerStimulusData('task', 2); 
...
clear all;
[task_data_gogogo, session_data] = cl_loadPerStimulusData('taskGo', 2); 
...
clear all;
[task_data_passive, session_data] = cl_loadPerStimulusData('passive', 5); 
