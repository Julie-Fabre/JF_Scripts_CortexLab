...
function cl_plot_average_task(task_data, idx, contra, center, passive)
...
if passive
    go1_contra = squeeze(task_data.psth{idx}(:, :, 2, :));
    go2_contra = squeeze(task_data.psth{idx}(:, :, 4, :));
    noGo_contra = squeeze(task_data.psth{idx}(:, :, 3, :));
else
    if contra
        % 1,2,3 = all the +90s
        % 13,14,15 %go1 [4]
...
for thisRegion = 1:size(plot_regions, 2)
        ...
        train_image = (train_image - nanmean(train_image(:, 1:200), 2)) ./ ...
            nanstd(train_image(:, 1:200), [], 2);
        [~, cell_idx] = sort(nanmean(train_image(:, 250:450), 2));

        %go 1
        test_image_go1 = squeeze(go1_contra(these_units, 2, :));
        test_image_go1 = (test_image_go1 - nanmean(test_image_go1(:, 1:200), 2)) ./ ...
        ...
        test_image_go2 = (test_image_go2 - nanmean(test_image_go2(:, 1:200), 2)) ./ ...
            nanstd(test_image_go2(:, 1:200), [], 2);
        smooth_filt = [region_smooth(iRegion), 10]; % (units x frames)
        ...
        test_image_noGo = (test_image_noGo - nanmean(test_image_noGo(:, 1:200), 2)) ./ ...
            nanstd(test_image_noGo(:, 1:200), [], 2);
        smooth_filt = [region_smooth(iRegion), 10]; % (units x frames)
        ...
        if ~passive
            ...
            test_image_noGoLike = (test_image_noGoLike - nanmean(test_image_noGoLike(:, 1:200), 2)) ./ ...
                nanstd(test_image_noGoLike(:, 1:200), [], 2);
            smooth_filt = [region_smooth(iRegion), 10]; % (units x frames)
            ...
            test_image_noGoLike2 = (test_image_noGoLike2 - nanmean(test_image_noGoLike2(:, 1:200), 2)) ./ ...
                nanstd(test_image_noGoLike2(:, 1:200), [], 2);
            smooth_filt = [region_smooth(iRegion), 10]; % (units x frames)
            ...
            test_image_noGoLike3 = (test_image_noGoLike3 - nanmean(test_image_noGoLike3(:, 1:200), 2)) ./ ...
                nanstd(test_image_noGoLike3(:, 1:200), [], 2);
            smooth_filt = [region_smooth(iRegion), 10]; % (units x frames)
            ...
            test_image_goLike = (test_image_goLike - nanmean(test_image_goLike(:, 1:200), 2)) ./ ...
                nanstd(test_image_goLike(:, 1:200), [], 2);
            smooth_filt = [region_smooth(iRegion), 10]; % (units x frames)
