...
function [raster_x, raster_y, t, curr_smoothed_psth,trial_sort,curr_raster_sorted]= getRaster(spike_templates,thisUnit,spike_timeline, thisAlign, thisSort, raster_window,psth_bin_size)
