...
%         if corona == 1
%             ephys_path = fullfile('E:/', thisAnimal, thisDate, '/ephys/kilosort2/');
%             if isempty(dir(strcat(ephys_path(1:end), '..')))
%                 ephys_path = fullfile('D:/', thisAnimal, thisDate, '/ephys/kilosort2/');
%             end
%             save_path = fullfile('E:/', thisAnimal, thisDate, '/analysis/');
%         else
