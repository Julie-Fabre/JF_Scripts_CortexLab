...
function [psth, bins, rasterX, rasterY, spikeCounts, binnedArray] = psthAndBA(spikeTimes, eventTimes, thisWindow, psthBinSize)
...
spikeTimes = spikeTimes(spikeTimes>min(eventTimes+thisWindow(1)) & spikeTimes<max(eventTimes+thisWindow(2)));

[binnedArray, bins] = timestampsToBinned(spikeTimes, eventTimes, psthBinSize, thisWindow);
