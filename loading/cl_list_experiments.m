function protocols = cl_list_experiments(animal,day)
...
experiments_dir = dir(cl_cortexlab_filename(animal,day,1,'expInfo'));
...
for curr_exp = 1:length(experiment_num)
    ...
    [block_filename, block_exists] = cl_cortexlab_filename(animal,day,experiment_num(curr_exp),'block');
    [protocol_filename,protocol_exists] = cl_cortexlab_filename(animal,day,experiment_num(curr_exp),'protocol');
