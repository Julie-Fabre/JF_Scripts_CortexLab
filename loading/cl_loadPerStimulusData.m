            ...
            for iExperiment = load_me_max 
                ...
                for iUnit = 1:size(units_to_keep, 1)
                    ...
                    for iCond = 1:size(passive_data_per_cond.psth_conditions{experiment_type}, 1)
                        ...
                        passive_data_per_cond.pvalue_shuffled_005_per_cond{experiment_type}(iUnit + unitCount, iCond) = ...
                            real_diff >= pctile_2 || real_diff <= pctile_1;

                        passive_data_per_cond.pvalue_shuffled_0025_per_cond{experiment_type}(iUnit + unitCount, iCond) = ...
