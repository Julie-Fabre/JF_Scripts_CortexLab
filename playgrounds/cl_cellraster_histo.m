function cl_cellraster_histo(align_times,align_groups,unit_sort)
...
depths_start =  evalin('base','depths_start');
depths_stop =  evalin('base','depths_stop');
catch me
...
line([0, 1], [depths_start, depths_start])
line([0, 1], [depths_stop, depths_stop])
