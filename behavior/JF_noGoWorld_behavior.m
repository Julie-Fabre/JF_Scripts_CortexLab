            ...
            for curr_experiment = find(trNum == max(trNum))
                try
                    ...
                    if isfield(block.events, 'trialQuiescenceValues')
                        ...
                        quiescence_reset_t = JF_extrap_stimWheel_quiescence(n_trials(2), signals_events, t, block2timeline, timeline2block, block, quiescThreshold);
                        [alt_stim_to_move, alt_stimOn_times] = JF_randsampleITI_stimToMove(n_trials(2), signals_events.responseTimes, ...
...
if plotAll
    ...
    for iAnimal = [5:7]
        ...
        transparencyValues = 0:1 / length(anBhv(iAnimal).noGoDay):1;
        for iDay = size(anBhv(iAnimal).noGoDay, 2)
            if iDay == size(anBhv(iAnimal).noGoDay, 2)
                col1 = rgb('DarkBlue');
                col2 = rgb('DarkRed');
            ...
            scatter([1, 2, 3], anBhv(iAnimal).goLeft(anBhv(iAnimal).noGoDay(iDay), [1, 2, 3])./anBhv(iAnimal).nTrials(anBhv(iAnimal).noGoDay(iDay), [1, 2, 3]), [], col1, 'filled', ...
                'MarkerFaceAlpha', transparencyValues(iDay+1), 'MarkerEdgeAlpha', transparencyValues(iDay+1))
            p = plot([1, 2, 3], anBhv(iAnimal).goLeft(anBhv(iAnimal).noGoDay(iDay), [1, 2, 3])./anBhv(iAnimal).nTrials(anBhv(iAnimal).noGoDay(iDay), [1, 2, 3]), 'Color', col1);
            p.Color(4) = transparencyValues(iDay+1);
            hold on;
            makepretty;
            scatter([1, 2, 3], anBhv(iAnimal).noGo(anBhv(iAnimal).noGoDay(iDay), [1, 2, 3])./anBhv(iAnimal).nTrials(anBhv(iAnimal).noGoDay(iDay), [1, 2, 3]), [], col2, 'filled', ...
                'MarkerFaceAlpha', transparencyValues(iDay+1), 'MarkerEdgeAlpha', transparencyValues(iDay+1))
            p = plot([1, 2, 3], anBhv(iAnimal).noGo(anBhv(iAnimal).noGoDay(iDay), [1, 2, 3])./anBhv(iAnimal).nTrials(anBhv(iAnimal).noGoDay(iDay), [1, 2, 3]), 'Color', col2);
            p.Color(4) = transparencyValues(iDay+1);
            makepretty;
        end
    ...
    if plotAll == true
        ...
        for iAnimal = 5:6
            ...
            transparencyValues = 0:1 / length(anBhv(iAnimal).noGoDay):1;
            if iAnimal == 6
                thiD = size(anBhv(iAnimal).noGoDay, 2) - 2:size(anBhv(iAnimal).noGoDay, 2);
                % thiD=thiD(1,2,4);
            elseif iAnimal == 5
                thiD = size(anBhv(iAnimal).noGoDay, 2) - 2:size(anBhv(iAnimal).noGoDay, 2);
                %thiD=thiD([1,2,4,5]);
            ...
            col2 = 'r';
            if length(thiD) == 1
                thisS = [anBhv(iAnimal).noGo(anBhv(iAnimal).noGoDay(thiD), [1, 2, 3]) ./ (anBhv(iAnimal).nTrials(anBhv(iAnimal).noGoDay(thiD), [1, 2, 3]))];
            else
                thisS = nanmean([anBhv(iAnimal).noGo(anBhv(iAnimal).noGoDay(thiD), [1, 2, 3]) ./ (anBhv(iAnimal).nTrials(anBhv(iAnimal).noGoDay(thiD), [1, 2, 3]))]);
                thisSt = nanstd([anBhv(iAnimal).noGo(anBhv(iAnimal).noGoDay(thiD), [1, 2, 3]) ./ (anBhv(iAnimal).nTrials(anBhv(iAnimal).noGoDay(thiD), [1, 2, 3]))]);
            end
            ...
            hold on;
            if length(thiD) == 1
                thisS = [anBhv(iAnimal).goLeft(anBhv(iAnimal).noGoDay(thiD), [1, 2, 3]) ./ (anBhv(iAnimal).nTrials(anBhv(iAnimal).noGoDay(thiD), [1, 2, 3]))];
            else

                thisS = nanmean([anBhv(iAnimal).goLeft(anBhv(iAnimal).noGoDay(thiD), [1, 2, 3]) ./ (anBhv(iAnimal).nTrials(anBhv(iAnimal).noGoDay(thiD), [1, 2, 3]))]);
                thisSt = nanstd([anBhv(iAnimal).goLeft(anBhv(iAnimal).noGoDay(thiD), [1, 2, 3]) ./ (anBhv(iAnimal).nTrials(anBhv(iAnimal).noGoDay(thiD), [1, 2, 3]))]);
            end
        ...
        for iAnimal = [5:7]
            ...
            for iDay = 1:size(anBhv(iAnimal).noGoDay, 2)
                ...
                thisS = [anBhv(iAnimal).noGo1(anBhv(iAnimal).noGoDay(iDay), 1) ./ (anBhv(iAnimal).nTrials(anBhv(iAnimal).noGoDay(iDay), 1) ./ 2), ...
                    anBhv(iAnimal).noGo2(anBhv(iAnimal).noGoDay(iDay), 1) ./ (anBhv(iAnimal).nTrials(anBhv(iAnimal).noGoDay(iDay), 1) ./ 2)];
            ...
            for iDay = 1:size(anBhv(iAnimal).noGoDay, 2)
                ...
                thisS = [anBhv(iAnimal).noGo1(anBhv(iAnimal).noGoDay(iDay), 3) ./ (anBhv(iAnimal).nTrials(anBhv(iAnimal).noGoDay(iDay), 3) ./ 2), ...
                    anBhv(iAnimal).noGo2(anBhv(iAnimal).noGoDay(iDay), 3) ./ (anBhv(iAnimal).nTrials(anBhv(iAnimal).noGoDay(iDay), 3) ./ 2)];
                scatter([1, 2], thisS, [], col2, 'filled', ...
                    'MarkerFaceAlpha', transparencyValues(iDay+1), 'MarkerEdgeAlpha', transparencyValues(iDay+1))
                p = plot([1, 2], thisS, 'Color', col2);
                p.Color(4) = transparencyValues(iDay+1);
        ...
        for iAnimal = 5:7
            ...
            scatter(1:length(animalsPhase1{iAnimal-4}), ...
                anBhv(iAnimal).goLeft(animalsPhase1{iAnimal-4}, 1)./anBhv(iAnimal).nTrials(animalsPhase1{iAnimal-4}, 1), [], animalCol{iAnimal-4}, 'filled');
            hold on;
            p(iAnimal) = plot(1:length(animalsPhase1{iAnimal-4}), ...
                anBhv(iAnimal).goLeft(animalsPhase1{iAnimal-4}, 1)./anBhv(iAnimal).nTrials(animalsPhase1{iAnimal-4}, 1), 'Color', animalCol{iAnimal-4});
            makepretty;
            hold on;
        ...
        for iAnimal = 5:7
            meanMovingFrac(iAnimal, :) = nanmean(anBhv(iAnimal).movingFrac(animalsPhase1{iAnimal-4}, :));
        ...
        hold on;
        for iAnimal = 5:7
            meanMovingFrac(iAnimal, :) = nanmean(anBhv(iAnimal).movingFrac(animalsPhase2{iAnimal-4}(1:end - 1), :));
            %     plot( meanMovingFrac(iAnimal,:), 'Color',rgb('DeepSkyBlue'))
            %     makepretty;
            %      hold on;
        end
        ...
        hold on;
        for iAnimal = 5:7
            meanMovingFrac(iAnimal, :) = anBhv(iAnimal).movingFrac(animalsPhase2{iAnimal-4}(end), :);
            %     plot( meanMovingFrac(iAnimal,:), 'Color',rgb('DeepSkyBlue'))
            %     makepretty;
            %      hold on;
        end
        ...
        figure();
        for iAnimal = 5:7
            meanMovingFrac(iAnimal, :) = anBhv(iAnimal).movingFrac(animalsPhase3{iAnimal-4}(end), :);
            %     plot( meanMovingFrac(iAnimal,:), 'Color',rgb('DeepSkyBlue'))
            %     makepretty;
            %      hold on;
        end
        ...
        for iAnimal = 5:7
            ...
            errorbar(iAnimal-4, nanmean(anBhv(iAnimal).stim_rxn_time(animalsPhase1{iAnimal-4})), ...
                nanstd(anBhv(iAnimal).stim_rxn_time(animalsPhase1{iAnimal-4})/sqrt(length(anBhv(iAnimal).stim_rxn_time(animalsPhase1{iAnimal-4})))), ...
                'Color', 'k', 'LineWidth', 2);
            makepretty;
            hold on;
            scatter(repmat(iAnimal-4, length(animalsPhase1{iAnimal-4}), 1), anBhv(iAnimal).stim_rxn_time(animalsPhase1{iAnimal-4}), [], cmap(2:end-2, :), 'filled');
            makepretty;
            hold on;
            scatter(iAnimal-4, nanmean(anBhv(iAnimal).stim_rxn_time(animalsPhase1{iAnimal-4})), [], 'k', 'filled');
            makepretty;
            hold on;
        end
        ylabel('Reaction time (s)')
        ...
        for iAnimal = 5:7
            ...
            errorbar(iAnimal-4+0.1, nanmean(anBhv(iAnimal).stim_rxn_time(animalsPhase2{iAnimal-4})), ...
                nanstd(anBhv(iAnimal).stim_rxn_time(animalsPhase2{iAnimal-4})/sqrt(length(anBhv(iAnimal).stim_rxn_time(animalsPhase2{iAnimal-4})))), ...
                'Color', 'k', 'LineWidth', 2);
            makepretty;
            hold on;
            scatter(repmat(iAnimal-4+0.1, length(animalsPhase2{iAnimal-4}), 1), anBhv(iAnimal).stim_rxn_time(animalsPhase2{iAnimal-4}), [], cmap(2:end-2, :), 'filled');
            makepretty;
            hold on;
            scatter(iAnimal-4+0.1, nanmean(anBhv(iAnimal).stim_rxn_time(animalsPhase2{iAnimal-4})), [], 'k', 'filled');
            makepretty;
            hold on;
        end
        ylabel('Reaction time (s)')
        ...
        for iAnimal = 5:7
            ...
            errorbar(iAnimal-4, nanmean(anBhv(iAnimal).stim_rxn_time(animalsPhase2{iAnimal-4})), ...
                nanstd(anBhv(iAnimal).stim_rxn_time(animalsPhase2{iAnimal-4})/sqrt(length(anBhv(iAnimal).stim_rxn_time(animalsPhase2{iAnimal-4})))), ...
                'Color', 'k', 'LineWidth', 2);
            makepretty;
            hold on;
            scatter(repmat(iAnimal-4, length(animalsPhase2{iAnimal-4}), 1), anBhv(iAnimal).stim_rxn_time(animalsPhase2{iAnimal-4}), [], cmap(2:end-2, :), 'filled');
            makepretty;
            hold on;
            scatter(iAnimal-4, nanmean(anBhv(iAnimal).stim_rxn_time(animalsPhase2{iAnimal-4})), [], 'k', 'filled');
            makepretty;
            hold on;
        end
        ylabel('Reaction time (s)')
        ...
        for iAnimal = 5:7
            ...
            errorbar(iAnimal-4+0.1, nanmean(anBhv(iAnimal).stim_rxn_time(animalsPhase3{iAnimal-4})), ...
                nanstd(anBhv(iAnimal).stim_rxn_time(animalsPhase3{iAnimal-4})/sqrt(length(anBhv(iAnimal).stim_rxn_time(animalsPhase3{iAnimal-4})))), ...
                'Color', 'k', 'LineWidth', 2);
            makepretty;
            hold on;
            scatter(repmat(iAnimal-4+0.1, length(animalsPhase3{iAnimal-4}), 1), anBhv(iAnimal).stim_rxn_time(animalsPhase3{iAnimal-4}), [], cmap(3:end-1, :), 'filled');
            makepretty;
            hold on;
        ...
        for iAnimal = 5:7
            for iDay = 1:length(animalsPhase4{iAnimal-4})
                ...
                plot([iAnimal - 4, iAnimal - 4 + 0.5], [anBhv(iAnimal).goLeft(animalsPhase4{iAnimal-4}(iDay)) ./ anBhv(iAnimal).nTrials(animalsPhase4{iAnimal-4}(iDay)), ...
                    anBhv(iAnimal).noGo(animalsPhase4{iAnimal-4}(iDay)) ./ anBhv(iAnimal).nTrials(animalsPhase4{iAnimal-4}(iDay))], 'Color', cmap(size(cmap, 1)+1-iDay, :));
                makepretty;
                hold on;
                scatter([iAnimal - 4, iAnimal - 4 + 0.5], [anBhv(iAnimal).goLeft(animalsPhase4{iAnimal-4}(iDay)) ./ anBhv(iAnimal).nTrials(animalsPhase4{iAnimal-4}(iDay)), ...
                    anBhv(iAnimal).noGo(animalsPhase4{iAnimal-4}(iDay)) ./ anBhv(iAnimal).nTrials(animalsPhase4{iAnimal-4}(iDay))], [], cmap(size(cmap, 1)+1-iDay, :), 'filled')
            end
        end
        ...
        for iAnimal = 5
            ...
            if iAnimal == 7
                ...
                thiD = size(anBhv(iAnimal).noGoDay, 2) - 1:size(anBhv(iAnimal).noGoDay, 2);
            elseif iAnimal == 5
                thiD = size(anBhv(iAnimal).noGoDay, 2) - 1:size(anBhv(iAnimal).noGoDay, 2);
            else
        ...
        for iAnimal = [5:7]
            ...
            for iDay = 1:size(animalsPhase4{iAnimal-4}, 2)
                ...
                scatter([1, 2, 3], anBhv(iAnimal).goLeft(animalsPhase4{iAnimal-4}(iDay), [1, 3, 2])./anBhv(iAnimal).nTrials(animalsPhase4{iAnimal-4}(iDay), [1, 3, 2]), [], col1, 'filled', ...
                    'MarkerFaceAlpha', transparencyValues(iDay+1), 'MarkerEdgeAlpha', transparencyValues(iDay+1))
                p = plot([1, 2, 3], anBhv(iAnimal).goLeft(animalsPhase4{iAnimal-4}(iDay), [1, 3, 2])./anBhv(iAnimal).nTrials(animalsPhase4{iAnimal-4}(iDay), [1, 3, 2]), 'Color', col1);
                p.Color(4) = transparencyValues(iDay+1);
                hold on;
                makepretty;
                scatter([1, 2, 3], anBhv(iAnimal).noGo(animalsPhase4{iAnimal-4}(iDay), [1, 3, 2])./anBhv(iAnimal).nTrials(animalsPhase4{iAnimal-4}(iDay), [1, 3, 2]), [], col2, 'filled', ...
                    'MarkerFaceAlpha', transparencyValues(iDay+1), 'MarkerEdgeAlpha', transparencyValues(iDay+1))
                p = plot([1, 2, 3], anBhv(iAnimal).noGo(animalsPhase4{iAnimal-4}(iDay), [1, 3, 2])./anBhv(iAnimal).nTrials(animalsPhase4{iAnimal-4}(iDay), [1, 3, 2]), 'Color', col2);
                p.Color(4) = transparencyValues(iDay+1);
                makepretty;
            end
        ...
        if plotAll
            ...
            iAnimal = 6
            plot(nanmean([anBhv(iAnimal).goLeft(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]) ./ (anBhv(iAnimal).nTrials(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]))]), 'Color', rgb('RoyalBlue'))
            makepretty;
            hold on;
            errorbar([1, 2], nanmean([anBhv(iAnimal).goLeft(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]) ./ (anBhv(iAnimal).nTrials(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]))]), ...
                nanstd([anBhv(iAnimal).goLeft(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]) ./ (anBhv(iAnimal).nTrials(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]))]./sqrt(2)), ...
                'Color', rgb('RoyalBlue'), 'LineWidth', 2)
            makepretty;
            hold on;
            plot(nanmean([anBhv(iAnimal).noGo(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]) ./ (anBhv(iAnimal).nTrials(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]))]), 'Color', rgb('IndianRed'))
            makepretty;
            hold on;
            errorbar([1, 2], nanmean([anBhv(iAnimal).noGo(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]) ./ (anBhv(iAnimal).nTrials(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]))]), ...
                nanstd([anBhv(iAnimal).noGo(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]) ./ (anBhv(iAnimal).nTrials(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]))]./sqrt(2)), ...
                'Color', rgb('IndianRed'), 'LineWidth', 2)
            makepretty;
            hold on;

            iAnimal = 5
            plot(nanmean([anBhv(iAnimal).goLeft(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]) ./ (anBhv(iAnimal).nTrials(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]))]), 'Color', rgb('Blue'))
            makepretty;
            hold on;
            errorbar([1, 2], nanmean([anBhv(iAnimal).goLeft(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]) ./ (anBhv(iAnimal).nTrials(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]))]), ...
                nanstd([anBhv(iAnimal).goLeft(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]) ./ (anBhv(iAnimal).nTrials(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]))]./sqrt(2)), ...
            ...
            hold on;
            plot(nanmean([anBhv(iAnimal).noGo(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]) ./ (anBhv(iAnimal).nTrials(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]))]), 'Color', rgb('Red'))
            makepretty;
            hold on;
            errorbar([1, 2], nanmean([anBhv(iAnimal).noGo(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]) ./ (anBhv(iAnimal).nTrials(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]))]), ...
                nanstd([anBhv(iAnimal).noGo(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]) ./ (anBhv(iAnimal).nTrials(animalsPhase4{iAnimal-4}(end, -1:end), [1, 3]))]./sqrt(2)), ...
            ...
            min = [-0.1, 0, 0.1];
            for iAnimal = 5:7
                phases = [sum(anBhv(iAnimal).n_trials(animalsPhase1{iAnimal-4}, :), 2); sum(anBhv(iAnimal).n_trials(animalsPhase2{iAnimal-4}, :), 2); ...
                    sum(anBhv(iAnimal).n_trials(animalsPhase3{iAnimal-4}, :), 2); sum(anBhv(iAnimal).n_trials(animalsPhase4{iAnimal-4}, :), 2); sum(anBhv(iAnimal).n_trials(animalsPhase5{iAnimal-4}, :), 2)];
                p(iAnimal) = plot(phases+min(iAnimal-4), 'Color', animalCol{iAnimal-4});
                makepretty;
                hold on;
            end
        ...
        for iMouse = [5:6]
            ...
            transparencyValues = 0:1 / length(anBhv(iMouse).noGoDay):1;
            for iDay = 1:size(anBhv(iMouse).noGoDay, 2)
                if iDay == size(anBhv(iMouse).noGoDay, 2)
                    col1 = rgb('DarkBlue');
                    col2 = rgb('DarkRed');
                ...
                scatter([1, 2, 3], anBhv(iMouse).goLeft(anBhv(iMouse).noGoDay(iDay), [1, 3, 2])./anBhv(iMouse).nTrials(anBhv(iMouse).noGoDay(iDay), [1, 3, 2]), [], col1, 'filled', ...
                    'MarkerFaceAlpha', transparencyValues(iDay+1), 'MarkerEdgeAlpha', transparencyValues(iDay+1))
                p = plot([1, 2, 3], anBhv(iMouse).goLeft(anBhv(iMouse).noGoDay(iDay), [1, 3, 2])./anBhv(iMouse).nTrials(anBhv(iMouse).noGoDay(iDay), [1, 3, 2]), 'Color', col1);
                p.Color(4) = transparencyValues(iDay+1);
                hold on;
                makepretty;
                scatter([1, 2, 3], anBhv(iMouse).noGo(anBhv(iMouse).noGoDay(iDay), [1, 3, 2])./anBhv(iMouse).nTrials(anBhv(iMouse).noGoDay(iDay), [1, 3, 2]), [], col2, 'filled', ...
                    'MarkerFaceAlpha', transparencyValues(iDay+1), 'MarkerEdgeAlpha', transparencyValues(iDay+1))
                p = plot([1, 2, 3], anBhv(iMouse).noGo(anBhv(iMouse).noGoDay(iDay), [1, 3, 2])./anBhv(iMouse).nTrials(anBhv(iMouse).noGoDay(iDay), [1, 3, 2]), 'Color', col2);
                p.Color(4) = transparencyValues(iDay+1);
                makepretty;
            end
