...
try
    ...
    if thisDate > datetime(2022,02,26) %Laura starts training 
        ...
        saveas(figure(6), ['~/Documents/cronJobPlots/', thisDate, '_JF072_behaviorLines.png'])%save behavior plots 
        saveas(figure(7), ['~/Documents/cronJobPlots/', thisDate, '_JF075_behaviorLines.png'])%save behavior plots 
        saveas(figure(8), ['~/Documents/cronJobPlots/', thisDate, '_JF076_behaviorLines.png'])%save behavior plots 
        saveas(figure(9), ['~/Documents/cronJobPlots/', thisDate, '_JF077_behaviorLines.png'])%save behavior plots 
        ...
        pause(50)
        saveas(figure(1), ['~/Documents/cronJobPlots/', thisDate, '_JF072_behaviorDetails.png'])%save behavior plots
        saveas(figure(2), ['~/Documents/cronJobPlots/', thisDate, '_JF075_behaviorDetails.png'])%save behavior plots
        saveas(figure(3), ['~/Documents/cronJobPlots/', thisDate, '_JF076_behaviorDetails.png'])%save behavior plots
        saveas(figure(54), ['~/Documents/cronJobPlots/', thisDate, '_JF077_behaviorDetails.png'])%save behavior plots
        close all;
